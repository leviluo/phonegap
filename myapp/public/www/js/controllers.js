    ...
    .controller('initCtrl', function($rootScope, $scope, storeService, $http, $ionicPopup) {
        ...
        .controller('RegisterCtrl', function($scope, $ionicPopup, $state, $state, HttpService) {
    ...
    .controller('messagesCtrl', function() {
        ...
        .controller('personal_messageCtrl', function() {



        })
        .controller('group_messageCtrl', function() {
